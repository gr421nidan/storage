const circleProfileStyle = "w-[60px] h-[60px] text-purple-light border-2 rounded-full border-purple dark:border-purple-light flex items-center justify-center";
