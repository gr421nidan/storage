...
import automaticCleanupDiskRepository from "@/entities/repo/user-storage/automatic-cleanup-disk";
...
const useAutomaticCleanupDiskUseCase = () => {
    ...
    return useMutation<void, AxiosError<IApiErrorDto>, IAutomaticCleanupDiskPort>({
        mutationFn: execute,
        onSuccess: async () => {
